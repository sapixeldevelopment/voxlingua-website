...
export default function YouTubeLink() {
  return <a className="site-youtube-link" href="https://www.youtube.com/@Dexlyy_5M" target="_blank" rel="noopener noreferrer" aria-label="Dexlyy on YouTube (opens in a new tab)">
