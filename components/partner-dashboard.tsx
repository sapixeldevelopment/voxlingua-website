...
export default function PartnerDashboard({ signedIn, email }: { signedIn: boolean; email: string }) {
  ...
  const [name, setName] = useState(''), [promotion, setPromotion] = useState(''), [country, setCountry] = useState(''), [recipient, setRecipient] = useState(email), [agreed, setAgreed] = useState(false);
