...
export default function Home() {
  const structuredData = {
    ...
    offers: { "@type": "AggregateOffer", lowPrice: BILLING_PLANS.starter.price, highPrice: BILLING_PLANS.ultra.price, priceCurrency: "USD", offerCount: PLAN_KEYS.length },
  };
  return <main className="site-page" id="top">
    <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(structuredData).replace(/</g, "\\u003c") }} />
    <a className="site-skip" href="#main-content">Skip to content</a>
    <div className="site-announcement"><span className="site-status-dot" /> Your interview room. Open around the clock.<a href="#pricing">Plans from $10 <ArrowRight size={12} /></a></div>
    <MarketingNavigation />
    <section className="site-hero site-container" id="main-content">
      <div className="site-hero-copy">
        ...
        <div className="site-hero-proof"><span><CheckCircle2 size={15} /> From $10/month</span><span><CheckCircle2 size={15} /> Your team makes the final call</span></div>
      </div>
    ...
    <section className="site-section site-container" id="product">
      <div className="site-section-heading"><div><span className="site-eyebrow">LESS ADMIN. MORE COMMUNITY.</span><h2>Make a great first impression.<br /><em>Without being on call.</em></h2></div><p>From the first application to the welcome role, give every player a clear path in—and your staff room to breathe.</p></div>
      <div className="site-benefits">
        <article className="site-benefit site-benefit-featured"><div className="site-card-top"><span className="site-icon"><Clock3 size={22} /></span><span className="site-card-index">01 / AVAILABILITY</span></div><h3>Your server never sleeps.<br />Your staff can.</h3><p>Players interview when they are ready, across time zones. No booking slots or chasing the next available admin.</p><div className="site-timezones" aria-label="Interviews available around the clock"><span><i /> London<small>Morning</small></span><span><i /> Los Angeles<small>After hours</small></span><span><i /> Sydney<small>Evening</small></span></div><div className="site-availability"><span className="site-status-dot" /> Always ready for the next introduction<Clock3 size={15} /></div></article>
        <article className="site-benefit"><div className="site-card-top"><span className="site-icon"><ListChecks size={22} /></span><span className="site-card-index">02 / CONSISTENCY</span></div><h3>Your standards.<br />Every conversation.</h3><p>Set your own questions and scenarios. Give applicants a consistent interview built around what matters to your community.</p><div className="site-question-sample"><span><Check size={13} /> Roleplay experience</span><span><Check size={13} /> Community expectations</span><span><Check size={13} /> Your custom scenarios</span></div></article>
        <article className="site-benefit"><div className="site-card-top"><span className="site-icon"><Users size={22} /></span><span className="site-card-index">03 / CONTROL</span></div><h3>AI does the interview.<br />You make the call.</h3><p>Hear the answers. Read the transcript. Review together in one workspace, then welcome the players who fit your community.</p><div className="site-review-sample"><span className="site-avatar">JR</span><div><strong>Ready for your review</strong><small>Recording and transcript together</small></div><CheckCircle2 size={20} /></div></article>
      </div>
    </section>
