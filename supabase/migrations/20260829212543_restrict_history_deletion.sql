drop policy if exists "managers delete decided applications" on public.applications;
create policy "owners and admins delete decided applications"
...
drop policy if exists "managers delete decided interview recordings" on storage.objects;
create policy "owners and admins delete decided interview recordings"
  on storage.objects
  for delete
  to authenticated
  using (
